...
namespace SkillMatrixManagement.Repositories
{
    public class ProjectEmployeeRepository : EfCoreRepository<SkillMatrixManagementApplicationDbContext, ProjectEmployee, Guid>, IProjectEmployeeRepository
    {
...

        {
            ...
            if (exists)
                throw new BusinessException(SkillMatrixManagementDomainErrorCodes.ProjectEmployee.PERMISSION_EMPLOYEE_ALREADY_ASSIGNED, "Employee is already assigned to this project");
        ...
        public async Task<ProjectEmployee> GetByIdAsync(Guid id)
        {
            ...
            var projectEmployee = await dbContext.Set<ProjectEmployee>().FindAsync(id)
                ?? throw new BusinessException(SkillMatrixManagementDomainErrorCodes.ProjectEmployee.PERMISSION_PROJECT_EMPLOYEE_NOT_FOUND, "Project Employee not found");
        ...
        public async Task UpdateAsync(ProjectEmployee projectEmployee)
        {
            ...
            var existing = await dbContext.Set<ProjectEmployee>()
                ...
                ?? throw new BusinessException(SkillMatrixManagementDomainErrorCodes.ProjectEmployee.PERMISSION_PROJECT_EMPLOYEE_NOT_FOUND_FOR_UPDATE, "Project Employee not found for update");
        ...
        public async Task SoftDeleteAsync(Guid projectEmployeeId)
        {
            ...
            if (projectEmployee.IsDeleted)
                throw new BusinessException(SkillMatrixManagementDomainErrorCodes.ProjectEmployee.PERMISSION_PROJECT_EMPLOYEE_ALREADY_DELETED, "Project Employee is already deleted");
        ...
        public async Task PermanentDeleteAsync(Guid projectEmployeeId)
        {
            ...
            if (projectEmployee == null)
                throw new BusinessException(SkillMatrixManagementDomainErrorCodes.ProjectEmployee.PERMISSION_PROJECT_EMPLOYEE_NOT_FOUND_FOR_DELETE, "Project Employee not found for deletion");
        ...
        public async Task RestoreProjectEmployeeAsync(Guid projectEmployeeId)
        {
            ...
            if (projectEmployee == null || !projectEmployee.IsDeleted)
                throw new BusinessException(SkillMatrixManagementDomainErrorCodes.ProjectEmployee.PERMISSION_PROJECT_EMPLOYEE_NOT_FOUND_OR_NOT_DELETE, "Project Employee not found or not deleted");
