...
namespace SkillMatrixManagement.Migrations.SkillMatrixManagementApplicationDb
{
    ...
    [Migration("20250508094133_FixPercentageSpellingUserModel")]
    partial class FixPercentageSpellingUserModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SkillMatrixManagement.Models.User", b =>
                {
                    ...
                    b.HasIndex("AvailabilityPercentage");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("AvailabilityPercentage"), "HASH");
