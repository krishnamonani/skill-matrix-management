...
namespace SkillMatrixManagement.Migrations.SkillMatrixManagementApplicationDb
{
    ...
    [Migration("20250417153524_AddRoleDepartmentAndDepartmentSkillFix")]
    partial class AddRoleDepartmentAndDepartmentSkillFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SkillMatrixManagement.Models.DepartmentSkill", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("DepartmentName"), "HASH");
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("SkillName"), "HASH");
