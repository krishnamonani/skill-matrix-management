...
public class SkillMatrixManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SkillMatrixManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
