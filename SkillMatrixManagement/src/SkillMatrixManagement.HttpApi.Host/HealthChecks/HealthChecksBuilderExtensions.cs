...
{
    public static void AddSkillMatrixManagementHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<SkillMatrixManagementDatabaseCheck>("SkillMatrixManagement DbContext Check", tags: new string[] { "database" });
