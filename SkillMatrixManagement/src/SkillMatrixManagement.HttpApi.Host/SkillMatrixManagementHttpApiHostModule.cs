...
using SkillMatrixManagement.HealthChecks;
...
[DependsOn(
    typeof(SkillMatrixManagementHttpApiModule),
...
public class SkillMatrixManagementHttpApiHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("SkillMatrixManagement");
    ...
    private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "SkillMatrixManagement API", Version = "v1" });
    ...
    {
        context.Services.AddSkillMatrixManagementHealthChecks();
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "SkillMatrixManagement API");
